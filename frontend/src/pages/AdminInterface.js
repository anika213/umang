...
async function viewPaintingHistory(paintingNumber) {
  try {
    const response = await axios.put('https://frontend-umang-ttltu.ondigitalocean.app/admin/viewhistory', { "paintingnumber": paintingNumber });
...
async function endBidding(){
  MySwal.fire({
    ...
    if (result.isConfirmed) {
      try {
        const response = await axios.get('https://frontend-umang-ttltu.ondigitalocean.app/admin/endbidding');
...
function Admin() {
  ...
  if (admin === false) {
    ...
    function handleDownloadClick() {
      ...
      axios.get("https://frontend-umang-ttltu.ondigitalocean.app/allbids/biddinginfo")
        .then((response) => {
          const { data } = response;
