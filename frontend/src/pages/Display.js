...
async function bid(art_number){  
  ...
  await axios.put('https://umang-818y.onrender.com/allbids/placebid',{paintingnumber,name,bidvalue})
  .then(async (val)=>{
  ...
  fetchData();
        ...
        return (
          <div>
            ...
            <h1>Art Gallery</h1>
            <p1 className="tiptext"> TIP: Click on a painting to view more info about its size, description, and medium </p1>
